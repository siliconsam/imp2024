...
This distribution contains:-
    ...
    2) source code for utilities (written in IMP-77 and Free Pascal) used to analyse
       the .ibj and .icd files generated by the IMP compiler pass1 and pass2 programs
